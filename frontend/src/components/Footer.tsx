        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          >
            ...
            <ul className="space-y-4">
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">All Collections</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Winter Edition</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Discount</a></li>
            </ul>
          </motion.div>
          ...
          >
            ...
            <ul className="space-y-4">
              ...
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Legal & Privacy</a></li>
            </ul>
          </motion.div>
          ...
          >
            ...
            <p className="text-gray-400">Subscribe to our newsletter and receive exclusive offers every week</p>
